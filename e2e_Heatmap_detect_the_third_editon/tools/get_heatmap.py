...
class Generate_heatmap:
    ...
    def __call__(self,joints):
        """
        # args:
        #   joints.shape = (n_person,17,4)    $ 4 = x,y,vis,sigma       # x,y取值0~1
        # return:
        ...
        for i , person_joints in enumerate(joints):
            ...
            for j , joint in enumerate(person_joints):
                ...
                if x < 0 or y < 0 or \
                        ...
                        continue
                tl , br = (x-self.kernal_r , y-self.kernal_r) , (x+self.kernal_r+1,y+self.kernal_r+1)
                ...
                heatmap[i,j,h_y1:h_y2,h_x1:h_x2] = self.gauss_kernal[k_y1:k_y2,k_x1:k_y2]
